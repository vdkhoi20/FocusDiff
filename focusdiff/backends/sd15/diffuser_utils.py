    ...
    def __call__(
        ...
        **kwds):
        ...
        for i, t in enumerate(tqdm(self.scheduler.timesteps, desc="DDIM Sampler")):
            ...
            model_inputs[1]=ref_intermediates[-1-i]
            model_inputs[2]=ref_intermediate_objects[-1-i]

            model_inputs = torch.cat([model_inputs,latents[-1:].clone().detach()])
